    ...
    <Layout>
      ...
      <section>
        ...
        <p>
          ...
          رزومه قبلیم هستش هنوز که با Material-Ui و Reactدرست شده. هنوز خیلی جای
          کار داشت و داره که نصفه و نیمه ول شده تا یه روزی ...
        </p>
        <p className={styles.paragraph}>
          سوابق کاری که انجام دادم از سال اول دانشگاه شروع کردم و چندین شغل
          مختلف و چالش های مختلف رو تجربه کردم تا بلاخره اون شعلی که مد نظرم هست
          و بهش علاقه دارم رو پیدا کردم. دادم
        </p>
        <ul>
